    ...
    Colorpicker.prototype = {
      ...
      updateInput: function(val) {
        ...
        if (this.input !== false) {
          ...
          if(elem_clicked != null && elem_clicked != undefined) {
            
            if($('.container_color1').is(':visible')) {
                $('.individual_color')[0].style.background = val;
                var new_color = '#' + val.substr(1);
                // selection.get_element().material.color.setHex(new_color);
                // selection.get_element().colorvalue = new_color
